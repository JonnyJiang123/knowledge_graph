...
export class Settings {
  ...
  // Database
  public readonly mysqlUri: string = process.env.MYSQL_URI || 'mysql://root:password@localhost:3306/knowledge_graph';
  ...
  // Auth
  public readonly secretKey: string = process.env.SECRET_KEY || 'change-this-in-production-use-openssl-rand-hex-32';
  public readonly algorithm: string = process.env.ALGORITHM || 'HS256';
  public readonly accessTokenExpireMinutes: number = parseInt(process.env.ACCESS_TOKEN_EXPIRE_MINUTES || '30');

  // Processing
  public readonly syncFileSizeLimit: number = parseInt(process.env.SYNC_FILE_SIZE_LIMIT || '5242880'); // 5MB
  ...
  public readonly encryptionKey: string = process.env.ENCRYPTION_KEY || 'qsXlU9kZ0w6zKz5g7zxubUoilT0yoyS9MhUlCT3VkOQ=';
